...
== Current
I am happy to say that in theory, this could work for you just fine. Given you run xfce4 and use a 16:9 monitor.
With that said, it should work juuuusst fine;) .
